...
class TestShiftMaterial(unittest.TestCase):
    ...
    def _csv(self, path):
        def row(date, peredel, t, mach, prib=""):
            return {"Передел": peredel, "Дата. Факт": date, "Подразделение": "Эрел",
                    ...
                    "Марка транспортировочной единицы": "HD465-7",
                    "Марка промывочного прибора": prib, "Инв. № промывочного прибора": "100",
                    "Время": t}
        rows = [
            row("2026-06-28", "Транспортировка торфов", "09:00", 5),   # день
            row("2026-06-28", "Транспортировка торфов", "22:00", 3),   # ночь
            row("2026-06-28", "Транспортировка песков", "10:00", 2, prib="СБ-2.1"),  # песок на прибор
